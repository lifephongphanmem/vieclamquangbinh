...
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">DANH MỤC CHI TIẾT {{ $tennhom->tentgktct }}</h3>
                    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{ $item->stt }} </td>
                                    <td class="text-left">{{ $item->tentgktct2 }}</td>
                                    <td>{{ $item->mota }}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <button title="Xóa thông tin" data-toggle="modal"
                                            ...
                                            onclick="cfDel('{{ '/danh_muc/dm_tinh_trang_tham_gia_hdkt/chi_tiet_2/delete/' . $item->id }}')"
                                            class="btn btn-sm btn-clean btn-icon">
                    ...
                    <div style="text-align: center">
                        <a href="{{ '/danh_muc/dm_tinh_trang_tham_gia_hdkt/chi_tiet?manhom='.$nhom }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="card-label">
                       Thông tin danh mục chi tiết {{ $tennhom->tentgktct }}
                    </h3>
                ...
                {!! Form::open([
                    'url' => '/danh_muc/dm_tinh_trang_tham_gia_hdkt/chi_tiet_2/store_update',
                    'method' => 'post',
                    'id' => 'frm_create_edit',
                ]) !!}
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <input type="text" id="manhom2" name="manhom2" value="{{ $tennhom->madmtgktct }}" hidden />
                        <div class="col-xl-12">
                        ...
                        <div class="col-xl-12">
                            <div class="form-group fv-plugins-icon-container">
                                ...
                                <input type="text" id="tentgktct2" name="tentgktct2" class="form-control" />
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="form-group fv-plugins-icon-container">
    ...
    <script>
        ...
        function edit(id) {
            ...
            $.ajax({
                url: '/danh_muc/dm_tinh_trang_tham_gia_hdkt/chi_tiet_2/edit/' + id,
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
                ...
                success: function(data) {
                    ...
                    form.find("[name='tentgktct2']").val(data.tentgktct2);
