            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">DANH MỤC LOẠI VÀ HIỆU LỰC HỢP ĐỒNG LAO ĐỘNG</h3>
                    </div>
                        ...
                        <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                            <thead>
                                <tr class="text-center">
                                    <th width="5%"> STT </th>
                                    <th>Tên loại, hợp động lao động</th>
                                    <th>Mô tả</th>
                                    <th>Trạng thái</th>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{$item->stt }} </td>
                                    <td class="text-left">{{ $item->tenlhl}}</td>
                                    <td>{{ $item->mota}}</td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <button title="Xóa thông tin" data-toggle="modal" data-target="#delete-modal-confirm" type="button" 
                                         onclick="cfDel('{{'/danh_muc/dm_loai_hieu_luc_hdld/delete/'.$item->id}}')"  class="btn btn-sm btn-clean btn-icon">
...
<div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           {!! Form::open(['url'=>'/danh_muc/dm_loai_hieu_luc_hdld/store_update', 'method'=>'post','id' => 'frm_create_edit'])!!}       
            @csrf
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
                            <label><b>Tên loại, hợp đồng lao động*</b></label>
                            <input type="text" id="tenlhl" name="tenlhl" class="form-control" />
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url: '/danh_muc/dm_loai_hieu_luc_hdld/edit/'+id,
            type: 'GET',
            data: {
                _token: CSRF_TOKEN,
                id: id
            ...
            success: function (data) {
                ...
                form.find("[name='tenlhl']").val(data.tenlhl);
