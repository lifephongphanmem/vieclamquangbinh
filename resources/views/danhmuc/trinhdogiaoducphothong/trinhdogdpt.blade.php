                        ...
                        <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                            <thead>
                                <tr class="text-center">
                                    <th width="5%"> STT </th>
                                    <th>Tên trình độ <br>GDPT cao nhất</th>
                                    <th>Trạng thái</th>
...
<div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           {!! Form::open(['url'=>'/danh_muc/dm_trinh_do_gdpt/store_update', 'method'=>'post','id' => 'frm_create_edit'])!!}       
            @csrf
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
                            <label><b>Tên trình độ GDPT cao nhất*</b></label>
                            <input type="text" id="tengdpt" name="tengdpt" class="form-control" />
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
