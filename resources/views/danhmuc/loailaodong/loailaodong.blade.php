            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">DANH MỤC LOẠI LAO ĐỘNG</h3>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{$item->stt }} </td>
                                    <td class="text-left">{{ $item->tenlld}}</td>
                                    <td>
                                    ...
                                    <td>
                                        @if (chkPhanQuyen('loailaodong', 'thaydoi'))
                                        <button title="Sửa thông tin" data-toggle="modal" data-target="#create_edit_modal" type="button" onclick="edit('{{$item->id}}')" class="btn btn-sm btn-clean btn-icon">
                                            <i class="icon-lg la flaticon-edit-1 text-primary"></i>
                                        </button>
                                        <button title="Xóa thông tin" data-toggle="modal" data-target="#delete-modal-confirm" type="button"  onclick="cfDel('{{'/danh_muc/dm_loai_lao_dong/delete/'.$item->id}}')"  class="btn btn-sm btn-clean btn-icon">
...
<div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           {!! Form::open(['url'=>'/danh_muc/dm_loai_lao_dong/store_update', 'method'=>'post','id' => 'frm_create_edit'])!!}       
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
                            ...
                            <input type="text" id="stt" name="stt" value="{{ $count + 1 }}" class="form-control" />
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
                            <label><b>Tên loại lao động*</b></label>
                            <input type="text" id="tenlld" name="tenlld" class="form-control" />
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="form-group fv-plugins-icon-container">
...
<script>
    ...
    function edit(id){
        ...
        $.ajax({
            url: '/danh_muc/dm_loai_lao_dong/edit/'+id,
            type: 'GET',
            data: {
                _token: CSRF_TOKEN,
                id: id
            ...
            success: function (data) {
                ...
                form.find("[name='tenlld']").val(data.tenlld);
