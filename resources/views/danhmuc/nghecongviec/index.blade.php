            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">Danh mục nghề công việc</h3>
                    </div>
                ...
                <div class="card-body">
                    <table id="sample_3" class="table table-striped table-bordered table-hover dataTable no-footer">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td >{{ ++$key }}</td>
                                <td name='tendanhmuc' class="text-left">{{ $cm->tendm }}</td>
                                    <td class="text-center">
                                        ...
                                        <button onclick="edit(this,'{{ $cm->id }}')"
                                            ...
                                            <button title="Xóa thông tin" type="button" onclick="cfDel('{{'/nghe_cong_viec/delete/'.$cm->id}}')" class="btn btn-sm btn-clean btn-icon" data-target="#delete-modal-confirm" data-toggle="modal">
