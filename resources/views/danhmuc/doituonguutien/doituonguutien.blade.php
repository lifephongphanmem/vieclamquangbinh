...
@section('content')
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <button title="Xóa thông tin" data-toggle="modal"
                                            ...
                                            onclick="cfDel('{{ '/danh_muc/dm_doi_tuong/delete/' . $item->id }}')"
                                            class="btn btn-sm btn-clean btn-icon">
    ...
    <div class="modal fade" id="create_edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['url' => '/danh_muc/dm_doi_tuong/store_update', 'method' => 'post', 'id' => 'frm_create_edit']) !!}
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="form-group fv-plugins-icon-container">
                                ...
                                <input type="text" id="stt" name="stt" value="{{ $count + 1 }}"
                                    class="form-control" />
                            </div>
                        </div>
                        <div class="col-xl-12">
    ...
    <script>
        ...
        function edit(id) {
            ...
            $.ajax({
                url: '/danh_muc/dm_doi_tuong/edit/' + id,
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
