                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container-fluid">
                            ...
                            <label> <b>Nếu xóa thì sẽ xóa tất cả các nhân khẩu thuộc xã trên phần mềm trong kỳ điều tra
                                    ...
                                    {{-- moda khai báo không biến động --}}
                                    <div id="modal-khongbiendong" tabindex="-1" role="dialog" aria-hidden="true"
                                        class="modal fade">
                                        <form id="khongbiendong" method="GET" action="{{URL::to('laodong-fnothing')}}"
                                            accept-charset="UTF-8" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header modal-header-primary">
                                                        <h4 id="modal-header-primary-label" class="modal-title">Doanh nghiệp không có biến động trong kỳ?</h4>
                                                        <button type="button" data-dismiss="modal"
                                                            aria-hidden="true" class="close">&times;</button>
                                                    </div>
                                                    <div class="modal-footer">
