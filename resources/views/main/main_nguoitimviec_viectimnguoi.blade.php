@if (chkPhanQuyen('cunglaodong', 'phanquyen'))
    <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
        <a href="javascript:;" class="menu-link menu-toggle">
            <span class="menu-text">THỊ TRƯỜNG LAO ĐỘNG</span>
        ...
        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
            <ul class="menu-subnav">
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a href="{{'/ungtuyen'}}" class="menu-link">
                        <i class="fas fa-user-tag"  width="16" height="16"></i>
                        <span class="menu-text" style="margin-left: 10px">Đơn ứng tuyển</span>
                    </a>
                </li> --}}
                ...
                {{-- <li class="menu-item" aria-haspopup="true">
                    <a href="" class="menu-link">
                        ...
                        <span class="menu-text">Yêu cầu liên hệ</span>
                    </a>
                </li> --}}
            </ul>
        </div>
