...
@section('content')
    <table id="data_header">
        <tr>
            ...
            <td>
                <p style="text-align: right;">Mẫu số 03a/PL1</p>
            </td>
        </tr>
        <tr>
            <td  colspan="5"  style="text-align: center;font-weight: bold;font-size: 20px; text-transform: uppercase;" >PHIẾU ĐĂNG KÝ GIỚI
                THIỆU/CUNG ỨNG LAO ĐỘNG <br>
            </td>
        </tr>
        <tr>
            <td colspan="5" style="text-align: center">
                <i > (Dành cho người sử dụng lao động) </i>
            </td>
        </tr>
        <tr>
    ...
    <table id="data_body" cellspacing="0" cellpadding="0" border="1">
        ...
        <tr>
            ...
            <td>
                [<?php if ($vitritd->tdcmkt == 'Chưa qua đào tạo') {
                    echo 'x ';
                } ?> ] Chưa qua đào tạo<br>
        ...
        <tr>
            <td colspan="5" style="text-align: left">Mong muốn của doanh nghiệp đối với TTDVVL:
                [ <?php if ($tuyendung->yeucau == 'Tư vấn') {
                    echo 'x ';
                } ?>] Tư vấn;&emsp;&emsp;
                [ <?php if ($tuyendung->yeucau == 'Giới thiệu việc làm') {
                    echo 'x ';
                } ?> ] GT việc làm;&emsp;&emsp;
                [ <?php if ($tuyendung->yeucau == 'Cung ứng lao động') {
                    echo 'x ';
                } ?> ] Cung ứng LĐ</td>
        </tr>
        <tr>
