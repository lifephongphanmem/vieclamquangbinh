    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <form  method="POST" action="{{'/nhankhau/update/'.$ld->id.'?loailoi='.$loailoi}}" enctype='multipart/form-data'>
                        @csrf
                        <div class="card-body" id='dynamicTable'>
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group ">
                                            <label class="{{$ld->ngaysinh == null?'text-danger':''}}">Ngày tháng năm sinh</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="thamgiabhxh">
                                            ...
                                            @foreach ($a_thamgiabaohiem as $k=>$ct )
                                                <option value="{{$k}}" {{$ld->thamgiabhxh == $k?'selected':''}}>{{$ct}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="hdld">
                                            ...
                                            @foreach ($m_hopdongld as $k=>$ct )
                                                <option value="{{$ct->stt}}" {{$ld->hdld == $ct->stt?'selected':''}}>{{$ct->tenlhl}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-12 text-center">
                                        ...
                                        <a href="{{'/dieutra/danhsachloi_chitiet?loailoi='.$inputs['loailoi'].'&madv='.$ld->madv.'&kydieutra='.$ld->kydieutra.'&id='.$inputs['id'].'&mahuyen='.$inputs['mahuyen']}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
                                    </div>
                                </div>
                            </div>
                    </form>
