            ...
            <div class="card card-custom">
                <div class="card-header card-header-tabs-line">
                    <div class="card-title">
                        <h3 class="card-label text-uppercase">Chi tiết</h3>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="diachi" value="{{$ld->diachi}}" class="form-control">
                                    </div>
                                </div>
                                        ...
                                        <select name="chuyennganh" class="form-control">
                                            ...
                                            @foreach ($m_nganhnghe as $val)
                                                <option value="{{ $val->madm }}"
                                                    {{ $ld->chuyennganh == $val->madm ? 'selected' : '' }}>{{ $val->tendm }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="doituongtimvieclam" class="form-control" required>
                                            ...
                                            <option value="1" {{$ld->doituongtimvieclam==1?'selected':''}}>Chưa từng làm việc</option>
                                            <option value="2" {{$ld->doituongtimvieclam==2?'selected':''}}>Đã từng làm việc</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="vieclammongmuon" class="form-control">
                                            ...
                                            <option value="1" {{$ld->vieclammongmuon==1?'selected':''}}>Trong tỉnh, trong nước</option>
                                            <option value="2" {{$ld->vieclammongmuon==2?'selected':''}}>Đi làm việc ở nước ngoài</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="nganhnghemongmuon" class="form-control ">
                                            ...
                                            @foreach ($m_nganhnghe as $val)
                                                <option value="{{$val->madm}}" {{$ld->nganhnghemongmuon==$val->madm?'selected':''}}>{{$val->tendm}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="nganhnghemuonhoc" class="form-control">
                                            ...
                                            @foreach ($m_nganhnghe as $val)
                                                <option value="{{$val->madm}}" {{$ld->nganhnghemuonhoc==$val->madm?'selected':''}}>{{$val->tendm}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="trinhdochuyenmonmuonhoc" class="form-control selec2basic">
                                            ...
                                            <option value="1" {{$ld->trinhdochuyenmonmuonhoc==1?'selected':''}}>Sơ cấp</option>
                                            <option value="2" {{$ld->trinhdochuyenmonmuonhoc==2?'selected':''}}>Trung cấp</option>
                                            <option value="3" {{$ld->trinhdochuyenmonmuonhoc==3?'selected':''}}>Cao đẳng</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
