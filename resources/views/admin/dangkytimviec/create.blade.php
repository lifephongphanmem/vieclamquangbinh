                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-sm-offset-0 ">
                                                ...
                                                <select name="phiengd" class="form-control">
                                                    <option {{ $input['phien'] == 'Phiên định kỳ' ? 'selected' : '' }}>Phiên
                                                        định kỳ</option>
                                                    <option {{ $input['phien'] == 'Phiên đột xuất' ? 'selected' : '' }}>
                                                        Phiên đột xuất</option>
                                                    <option {{ $input['phien'] == 'Phiên online' ? 'selected' : '' }}>Phiên
                                                        online</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-4 col-sm-offset-0 ">
                                ...
                                <div class="col-md-12">
                                    <div class="card card-custom">
                                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                            <div class="card-title">
                                                <h3 class="card-label text-uppercase" id="nld">Thông tin người tìm
                                                    việc 1</h3>
                                            </div>
                                            <div class="card-toolbar">
                                                <!--begin::Button-->
