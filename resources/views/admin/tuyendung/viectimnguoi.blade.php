...
@section('content')
	...
	?>
				...
				?>
					...
					?>
                                ...
                                <td>
                                    <button onclick="inmau('{{ $td->id }}')" title="In mẫu" data-target="#inmau"
                                        data-toggle="modal" class="btn btn-sm btn-clean btn-icon"><i
                                            class="icon-lg la flaticon2-print text-primary"></i></button>
    ...
    <div id="inmau" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        <div class="modal-dialog modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="" id='mau03pli' target="_blank">2. Mẫu 03/PLI - Phiếu đăng ký doanh nghiệp</a><br>
                <a href="" onclick="get_vitri()" data-target="#modal-inbaocao" data-toggle="modal">3. Mẫu 03a/PLI - Phiếu đăng ký giới thiệu việc làm</a>
            </div>
    ...
    <script>
        ...
        function inmau(id) {
            $('#idtuyendung').val(id);
            var url_mau02 = '/vanban/thong_tin_nhu_cau_tuyen_dung?id=' + id;
            $('#mau02').attr('href', url_mau02);
            var url_mau03lli = '/vanban/mau_03lpi?id=' + id;
            $('#mau03pli').attr('href', url_mau03lli);
        }
    </script>
@endsection
