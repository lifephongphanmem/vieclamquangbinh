...
@section('content')
    <table id='data_header' width="96%" cellspacing="0" cellpadding="8"
        style="margin:0 auto 20px; text-align: center;font-size:13px">
        <tr>
            <td></td>
            <td></td>
            <td width="40%" colspan="4" style="vertical-align: top;text-align:center">
        ...
        <tr>
            <td></td>
            <td></td>
            <td colspan="4"  style="text-align: center">Số: ....../BC-SLĐTBXH</td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
            <td  colspan="4" style="text-align: right"><i style="margin-right: 30%;">Quảng Bình, ngày .... tháng .... năm ....</i></td>
            <td></td>
            <td></td>
        </tr>
    </table>
    ...
    <table id='data_body2' cellspacing="0" cellpadding="0" border="1"
        style="margin: 20px auto; border-collapse: collapse;font-size:13px">

        <tr>
            <th rowspan="2" style="width: 2%;">STT</th>
            <th rowspan="2" style="width: 5%;">Số báo danh</th>
            ...
            <th rowspan="2" style="width: 12%;">Phân loại</th>
        ...
        @foreach ($model as $k => $ct)
            <tr>
                ...
                <td class="text-center" style='mso-number-format:"@"'>{{ $ct->sobaodanh }}</td>
                <td>{{ $ct->hoten }}</td>
                <td style='mso-number-format:"@"'>{{ getDayVn($ct->ngaysinh) }}</td>
                <td class="text-center">{{ $ct->gioitinh == 1 ? 'Nam' : 'Nữ' }}</td>
                <td style='mso-number-format:"@"'>{{ $ct->cccd }}</td>
                ...
                <td class="text-center" style='mso-number-format:"@"'>{{ $ct->sdt }}</td>
                <td>{{ $ct->thonxom }}</td>
                <td>{{ $ct->xa }}</td>
                <td>{{ $ct->huyen }}</td>
                <td>{{ $ct->tinh }}</td>
