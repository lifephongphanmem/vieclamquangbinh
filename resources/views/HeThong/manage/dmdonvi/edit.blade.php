...
@stop
@section('content')
<form method="POST" action="{{'/dmdonvi/update/'.$model->id}}" accept-charset="UTF-8"  class="horizontal-form" id="update_dmdonvi" enctype="multipart/form-data">
    @csrf
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-4">
                    ...
                    <input class="form-control" required="" autofocus="" name="tendv" value="{{$model->tendv}}" type="text">
                </div>
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <select class="form-control select2me" name="madvcq">
                        ...
                        <option value="{{$donvi->madv}}" {{$model->madvcq == $donvi->madv?'selected':''}}>{{$donvi->tendv}}</option>                            
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <input class="form-control" name="diachi" value="{{$model->diachi}}" type="text">
                </div>

                <div class="col-lg-4">
                    <label>Địa danh</label>
                    <input class="form-control" name="diadanh" value="{{$model->diadanh}}" type="text">
                </div>                
            </div>
            ...
            <div class="form-group row">
                <div class="col-lg-4">
                    ...
                    <input class="form-control" name="chucvuky" value="{{$model->chucvuky}}" type="text">
                </div>

                <div class="col-lg-4">
                    <label>Họ tên người ký</label>
                    <input class="form-control" name="nguoiky" value="{{$model->nguoiky}}" type="text">
                </div>
            ...
            <div class="form-group row">
                <div class="col-lg-8">
                    ...
                    <input class="form-control" name="ttlienhe" value="{{$model->ttlienhe}}" type="text">
                </div>
            </div>
            <input type="hidden" name='madonvi' id=madonvi value="{{$model->id}}">
            <input type="hidden" name='madiaban' id=madiaban value="{{$model->madiaban}}">
        </div>
        <div class="card-footer">
            <div class="row text-center">
                <div class="col-lg-12">
                    <a href="{{$furl.'danh_sach_don_vi/'.$model->madiaban}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
