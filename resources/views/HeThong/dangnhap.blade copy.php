                    ...
                    <div class="login-wrapper">
                        <!--begin:Aside Content-->
							<div class="text-dark-75">
								...
								<button type="button" id="kt_login_signup" class="btn btn-outline-primary btn-pill py-4 px-9 font-weight-bold">ĐĂNG KÝ MỚI</button>
							</div>
							<!--end:Aside Content-->
                    </div>
                </div>
                ...
                <div class="d-flex w-100 flex-center p-15 position-relative overflow-hidden">
                    <div class="login-wrapper">
                        ...
                        <div class="login-signin">
                            ...
                            {!! Form::open(['url' => '/login-user', 'class' => 'form text-left']) !!}
                            ...
                            <div class="input-group form-group py-2 m-0">
                                ...
                                <input class="form-control border-1 px-5 placeholder-dark-75"
                                    title="Mật khẩu đăng nhập" type="Password" placeholder="Mật khẩu" id="password"
