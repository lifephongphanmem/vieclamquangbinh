            ...
            <ul class="menu-nav">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <rect fill="#000000" opacity="0.3" x="2" y="4"
                                        width="5" height="16" rx="1"></rect>
                                </g>
                            </svg>
                        </span>
                        <span class="menu-text font-weight-bold">Quản lý tuyển dụng</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            ...
                            {{-- <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('/tuyen_dung/khai_bao_tong_hop') }}" class="menu-link">
                                    ...
                                    <span class="menu-text font-weight-bold">Khai báo tuyển dụng tổng hợp</span>
                                </a>
                            </li>

                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{ url('/tuyen_dung/thong_tin_tong_hop') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        ...
                        <span class="menu-text font-weight-bold">Quản lý thông báo</span>
                        <i class="menu-arrow"></i>
                    </a>
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                ...
                                <span class="menu-text">Tổng hợp danh sách cung lao động toàn tỉnh</span>
                            </a>
                        </li>
